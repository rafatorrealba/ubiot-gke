...
function generateChannelArtifacts(){
    ...
    echo
        ...
        echo "#################################################################"
        $GOPATH/bin/configtxgen -configPath configtx -profile TwoOrgsChannel -outputAnchorPeersUpdate channel-artifacts/Org2Anchors.tx  -channelID "mychannel" -asOrg Org2MSP
        echo
}
